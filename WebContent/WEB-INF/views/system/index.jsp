...
<meta name="copyright"
	content="All Rights Reserved, Copyright (C) 2020, GreenBee Ltd." />
...
<body class="easyui-layout">
	...
	<div class="wu-sidebar"
		...
		<div class="easyui-accordion" data-options="border:false,fit:true">
			<c:forEach items="${allTopMenu}" var="topMenu">
				<div title="${topMenu.name}"
					data-options="iconCls:'${topMenu.icon}'" style="padding: 5px;">
					<ul class="easyui-tree wu-side-tree">
						<c:forEach items="${allSecondMenu}" var="secondMenu">
							<c:if test="${secondMenu.parentId==topMenu.id}">
								<li iconCls="${secondMenu.icon}"><a
									href="javascript:void(0)" data-icon="${secondMenu.icon}"
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2020 GreenBee All Rights Reserved
    </div>
    <!-- end of footer -->  
    <script type="text/javascript">
		$(function(){
