...
<body>
	...
	<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img">
					<img src="../resources/admin/login/images/yanzhengma.png">
				</div>
				<div class="login-center-input">
					<input type="text" name="cpacha" id="cpacha" value="" style="width: 50%" placeholder="请输入您的验证码"
						onfocus="this.placeholder=&#39;&#39;"
						onblur="this.placeholder=&#39;请输入您的验证码&#39;">
					<div class="login-center-input-text">验证码</div>
					<img id=cpacha-img title="点击刷新验证码" style="cursor: pointer;"
						src="get_cpacha?vl=4&w=120&h=40&type=loginCpacha" width="110px"
