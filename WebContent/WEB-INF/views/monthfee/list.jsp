...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').datagrid({
		...
		fit:true,
		columns:[[
			{ field:'category',title:'缴费类别',width:100,sortable:true},
			{ field:'price',title:'金额',width:100,sortable:true},
			{ field:'date',title:'缴纳日期',width:100,formatter:function(value,row,index){
				return format(value);
			}},
