...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').datagrid({
		...
		fit:true,
		columns:[[
			{ field:'house.houseId',title:'住房编号',width:100,formatter:function(value,row,index){
				return row.house.houseId;
			}},
			{ field:'house.user.username',title:'住房人',width:100,formatter:function(value,row,index){
				return row.house.user.username;
			}},
			{ field:'date',title:'最后缴纳日期',width:100,formatter:function(value,row,index){
				return format(value);
			}},
